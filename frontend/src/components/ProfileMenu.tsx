  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          className={cn(
            "w-full flex items-center gap-2 rounded-lg hover:bg-muted transition-colors text-left",
        ...
        >
          ...
          {!collapsed && <MoreHorizontal className="h-4 w-4 text-muted-foreground shrink-0 ml-auto" />}
        </button>
      </DropdownMenuTrigger>
