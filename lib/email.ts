...
export async function sendSupervisionSubmittedEmail(
  ...
  await resend.emails.send({
    ...
    html: `
      ...
      <p><a href="${process.env.NEXTAUTH_URL}/supervisor/supervision">Ver pendientes →</a></p>
    `,
  })
}
...
export async function sendSupervisionReviewedEmail(
  ...
  await resend.emails.send({
    ...
    html: `
      ...
      <p><a href="${process.env.NEXTAUTH_URL}/student/supervision">Ver historial →</a></p>
    `,
  })
}
...
export async function sendSessionRecordedEmail(
  ...
  await resend.emails.send({
    ...
    html: `
      ...
      <p><a href="${process.env.NEXTAUTH_URL}/supervisor/registros">Ver registros →</a></p>
    `,
  })
}
