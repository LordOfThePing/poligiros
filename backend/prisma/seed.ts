...
async function main() {
  ...
  await prisma.test.createMany({
    data: [
      ...
      { type: TestType.PLAN_VITAL, title: "Plan Vital Integral®", description: "Un recorrido guiado por 8 áreas de tu vida (salud, familia, finanzas, trabajo, vocación, etc.) más un ejercicio de Estímulos.", orderIndex: 3 },
      ...
      { type: TestType.TAREAS_EXPLORACION, title: "Tareas a explorar", description: "Anotá qué tareas de exploración te llevás para investigar después del Tablero de Ideas.", orderIndex: 5 },
      { type: TestType.MODELO_NEGOCIO, title: "Desarrollo de idea de negocio/proyecto/trabajo", description: "Explorá tu idea como un Modelo de Negocios Canvas, un camino freelance/autónomo o investigando un puesto de trabajo.", orderIndex: 6 },
    ],
  })
