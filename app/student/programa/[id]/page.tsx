...
export default function ModuleDetailPage() {
    ...
    fetch("/api/student/modules")
      ...
      .then((modules: Module[]) => {
        ...
        if (!found || found.locked) {
          router.replace("/student/programa")
        } else {
          setModule(found)
        }
      })
  ...
  async function handleComplete() {
    ...
    await fetch(`/api/student/modules/${id}/complete`, { method: "POST" })
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <Link href="/student/programa" className="text-muted-foreground hover:text-foreground">
